    ...
    <v-layout column>
      ...
      <v-flex>
        <v-layout row wrap align-center my-5>
          <v-flex xs10 md4 mx-auto>
            <img src="../assets/undraw_task_31wc.svg" alt="Tasks image" class="image">
          </v-flex>
          <v-flex xs12 md8>
      ...
      <v-flex>
        <v-layout row wrap align-center my-5>
          ...
          <v-flex xs10 md4 mx-auto>
            <img src="../assets/undraw_process.svg" alt="Process image" class="image">
          </v-flex>
        </v-layout>
      </v-flex>
      <v-flex xs12>
      ...
      <v-flex>
        <v-layout row wrap align-center my-5>
          <v-flex xs10 md4 mx-auto>
            <img src="../assets/undraw_done_checking.svg" alt="Checklist" class="image">
          </v-flex>
          <v-flex xs12 md8>
            <p class="title font-weight-regular mt-3 mx-5">
